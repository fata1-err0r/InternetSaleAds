...
namespace InternetSaleAds
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			adsList.Add(0, new Ads());
			adsList.Add(1, new Ads("Телефон", "iPont 99", 9999, 89000001111, "Вася", DateTime.Now));
			adsList.Add(2, new Ads("Консоль", "PayStation $", 3000, 89000002222, "Петя", DateTime.Now));
			adsList.Add(3, new Ads("Телевизор", "Pony", 5000, 89000003333, "Оля", DateTime.Now));
			adsList.Add(4, new Ads("Платье", "Гусси", 7000, 89000004444, "Катя", DateTime.Now));
			adsList.Add(5, new Ads("Кактус", "Колючий", 10, 890000005555, "Женя", DateTime.Now));
