...
namespace WinFormAds
{
	partial class FormISA
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridViewAdsList.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
			...
			this.dataGridViewModerAdsList.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle3;
			...
			this.dataGridViewModerAdsList.RowHeadersDefaultCellStyle = dataGridViewCellStyle5;
